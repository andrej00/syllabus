export default [
  {
    ...
    "Nositelj predmeta": "dr. sc. Tomislav Volarić, doc.",
    "Predavanja": "15",
    "Seminar": "0",
    "Vježbe": "30",
    "Kod": "INB1018",
    ...
    "ECTS bodovi": "4",
    "Ciljevi predmeta": "Ciljevi kolegija su: Urediti znanja stečena o ovom području u prethodnom obrazovanju. Razumjeti, usvojiti i naučiti proceduru i aktivnosti za rješavanje problema i razvoj programske podrške na računalu. Razumjeti, usvojiti i naučiti osnovni koncept programiranja sa stajališta programskih instrukcija za prihvat podataka, obrade podataka, spremanje i raspodjele rezultata obrade podataka. Razumjeti, usvojiti i naučiti osnovni concept za spremanje i ponovno korištenje podataka.",
...
Vježbe:
1.	Prijava na Moodle, Instalacija i rad u Pythonu, Razvojno okruženje programskog jezika Python (Python Shell), Aritmetički operatori 
2.	Tipovi varijabli, Print i Input naredbe 
3.	Logički i relacijski operatori, IF naredba 
4.	Ugrađene funkcije, Kompleksni brojevi, Stringovi – ugrađene funkcije 
5.	For i while petlja 
6.	Prosti brojevi, Pristup znamenkama brojeva, Pretvorba brojevnih sustava 
7.	Stringovi, Funkcije 
8.	Zadaci za pripremu kolokvija 
9.	Analiza kolokvija ili još ponavljanja 
10.	Nizovi 
11.	Sortiranje 
12.	Složeni zadaci s nizovima 
13.	Datoteke 
14.	Datoteke 
15.	Kolokvij 
`,
    ...
    "Podatci o ocjenjivanju i bodovanju studenata tijekom nastave i na završnom ispitu": `Prema Pravilniku o studiranju konačna se ocjena dobiva na sljedeći način: 
    0 – 55% nedovoljan (1)
    55 – 66% dovoljan (2)
    67 – 78% dobar (3)
    79 – 90% vrlodobar (4)
    91 – 100% odličan (5)
`,
    "Obvezna literatura": "Budin, L., Brođanac, P., Markučić, Z., Perić, S. (2012) Rješavanje problema programiranjem u Pythonu, Element, Zagreb, ISBN: 978-953-197-395- 3",
    "Dopunska literatura": "Griffiths, D., Barry, P. (2009) Head First Programming: A Learner's Guide to Programming Using the Python Language, ISBN: 978-0596802370",
  },
  {
